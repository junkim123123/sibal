...
import { CheckCircle, AlertTriangle, ArrowRight, Lock, Factory, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="relative rounded-lg bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 shadow-sm p-6 md:p-8 lg:p-10">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2 text-xs font-medium text-blue-600 hover:text-blue-700 transition-colors"
      >
        {isExpanded ? (
          <>
            <span>Show less</span>
