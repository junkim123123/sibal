...
|------|-------------|-------------------|
| **가격 모델** | Free, $49 디파짓 (환불 가능), 5% 실행 수수료 | ❌ "$199/월", "Pro 구독", "월간 구독", "Pro 플랜" |
...
| **데이터베이스** | Supabase (PostgreSQL) 전용 | ❌ "Prisma 사용", "Prisma ORM" |
...
> ⚠️ **중요**: `pro` 역할은 더 이상 사용하지 않습니다. 가격 모델이 $49 디파짓 + 5% 수수료로 변경되었습니다.
...
- `web/docs/HANDOVER.md` - ⭐ 이 문서 (정본)
- `web/docs/archive/` - 기존 문서 보관
