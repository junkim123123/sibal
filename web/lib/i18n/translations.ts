  ...
  en: {
    ...
    home: {
      hero: {
        ...
        subtitle: 'Get instant AI estimates on landed cost and risks. Review the numbers, then unlock a dedicated manager and real factory quotes within 7 days with a $49 deposit. Packaging and kitting available, billed separately.',
        subtitleHighlight1: 'instant AI estimates',
        subtitleHighlight2: 'real factory quotes within 7 days',
        subtitleHighlight3: 'Packaging and kitting available, billed separately',
      ...
      howItWorks: {
        ...
        steps: [
          ...
          },
          {
            ...
            description: 'We negotiate directly with verified manufacturers to secure the best FOB pricing and MOQ. Real factory quotes within 7 days.',
          },
          {
    ...
    dashboard: {
      ...
      payment: {
        ...
        creditedUponOrderDesc: 'Deposit is 100 percent credited to your first order.',
        ...
        nonRefundableNotice: 'Deposit is 100 percent credited to your first order.',
